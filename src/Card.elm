...
view card =
  div[class "flex content-start flex-col"][
      h1 [class "sm:text-yellow-600 font-semibold font-serif text-center text-2xl md:text-5xl"][text cardModel.name]
    , img[class "sm:p-5 mx-auto md:w-1/4 h-1/4", src "pics/sunflower_center.png"][]
    , ul [class "sm:p-5 leading-10 mx-auto text-left md:w-1/4"][
