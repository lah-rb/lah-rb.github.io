/* @ts-self-types="./rqrr_decode.d.ts" */
 ...
 * @returns {string}
 */
export function decode_qr_crop(rgba, width, height) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passArray8ToWasm0(rgba, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.decode_qr_crop(ptr0, len0, width, height);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('rqrr_decode_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
