...
fn scanning_ui() -> String {
  ...
  <div class="z-50 aspect-square fixed w-80 md:w-1/2 lg:w-1/3 -translate-x-1/2 lg:-translate-y-1/2 bottom-8 lg:bottom-1/2 left-1/2 rounded-lg transition delay-150">
