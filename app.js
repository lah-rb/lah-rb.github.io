	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('text-yellow-600 font-semibold font-serif text-center text-5xl')
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('p-5 mx-auto md:w-3/4 lg:w-1/3'),
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('p-5 text-4xl leading-10 mx-auto text-left md:w-3/4 md:text-2xl lg:w-1/3')
					]),
				_List_fromArray(
					[
						A2(
...
var $author$project$Card$main = $elm$browser$Browser$sandbox(
	{init: $author$project$Card$cardModel, update: $author$project$Card$update, view: $author$project$Card$view});
_Platform_export({'Card':{'init':$author$project$Card$main(
